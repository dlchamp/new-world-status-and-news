...
# CONFIG #
##########
# The page to scrape for server status - probably won't need to change
scrape_url = "https://www.newworld.com/en-us/support/server-status"
...
monitored_servers = ["Valgrind", "Eden", "Maca", "Savoya",
                     "Emain Albach", "Macaria"]  # List of server to update
